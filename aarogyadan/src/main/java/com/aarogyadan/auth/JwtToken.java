...
public class JwtToken {
	...
	public static String generateToken(String emailid, LoginUser user) throws Exception {
		try {
	...
	public static LoginUser decryptPayload(String encryptedMessage) throws Exception {
		try {
			Jws<Claims> ans = Jwts.parser().setSigningKey(key).parseClaimsJws(encryptedMessage);
