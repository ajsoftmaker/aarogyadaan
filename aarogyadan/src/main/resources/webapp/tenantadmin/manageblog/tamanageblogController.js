...
.controller('tamanageblogController', tamanageblogController);

function tamanageblogController($scope, $rootScope, $state, dialogs,
...
//	getBatches();
	...
	function getVolunteers() {
		var promise1 = restAPIService.blogsService().query();
	...
	$scope.onEdit = function(tenant) {
		...
		$scope.mode = "edit";
		$scope.id = tenant.id;
		$state.go("home.samanageblog.saaddblog");
	}
