...
angular.module('aarogyadanWebApp')
	.controller('taaddpatientController', taaddpatientController);

function taaddpatientController($scope,$rootScope,$state,dialogs,restAPIService,$location){
	$scope.patient={
			patientName : "",
			patientCity : "",
			patientTal : "",
...
//	$scope.validPatientPassword = function(valid){
//		$scope.patientPasswordValid = valid;
//		if($scope.patient.patientPassword.length>50 || $scope.patient.patientPassword.length<4) {
//			$scope.patientPasswordSuccess = false;
//			$scope.patientPasswordError = false;
//			$scope.patientPasswordFeedback = "";
//		} else {
//			$scope.patientPasswordSuccess = true;
//			$scope.patientPasswordError = false;
//			$scope.patientPasswordFeedback = "has-success has-feedback";
//		}
//	}
	
//	$scope.validPatientConfirmPassword = function(valid){
//		$scope.patientConfirmPasswordValid = valid;
//		if($scope.patientConfirmPassword != undefined) {
//			if($scope.patient.patientPassword != $scope.patientConfirmPassword) {
//				$scope.patientConfirmPasswordSuccess = false;
//				$scope.patientConfirmPasswordError = false;
//				$scope.patientConfirmPasswordFeedback = "has-error has-feedback";
//				$scope.patientConfirmPasswordValid = true;
//			} else {
//				$scope.patientConfirmPasswordSuccess = true;
//				$scope.patientConfirmPasswordError = false;
//				$scope.patientConfirmPasswordFeedback = "has-success has-feedback";
//				$scope.patientConfirmPasswordValid = false;
//			}
//		} else {
//			$scope.patientConfirmPasswordSuccess = false;
