...
.controller('tamanagepatientController', tamanagepatientController);

function tamanagepatientController($scope, $rootScope, $state, dialogs,
...
//	getBatches();
	...
	function getVolunteers() {
		var promise1 = restAPIService.patientsService().query();
	...
	$scope.addNewPatient = function() {
		$scope.parent = false;
		$scope.mode = "add";
		$state.go("home.tamanagepatient.taaddpatient");
	}
