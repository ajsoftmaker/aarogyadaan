...
angular.module('aarogyadanWebApp').controller('tamanagebackerController',
		tamanagebackerController);

function tamanagebackerController($scope, $rootScope, $state, dialogs,
...
//	getBatches();
	...
	$scope.onEdit = function(tenant) {
		...
		$scope.mode = "edit";
		$scope.id = tenant.id;
		$state.go("home.tamanagebacker.taaddbacker");
	}
