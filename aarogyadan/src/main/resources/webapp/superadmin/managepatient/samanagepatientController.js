...
.controller('samanagepatientController', samanagepatientController);

function samanagepatientController($scope, $rootScope, $state, dialogs,
...
//	getBatches();
	...
	$scope.addNewPatient = function() {
		$scope.parent = false;
		$scope.mode = "add";
		$state.go("home.samanagepatient.saaddpatient");
	}
