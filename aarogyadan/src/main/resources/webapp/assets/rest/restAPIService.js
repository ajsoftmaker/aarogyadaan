...
function restAPIService($resource, $rootScope, $http) {
	...
	return {
		...
		loginusersByLoginIdService : loginusersByLoginIdService,
	...
	function volunteersService() {
		var url = $rootScope.apiUrl + "volunteers";
		return $resource(url);
	}
	
	function volunteerService(id) {
		var url = $rootScope.apiUrl + "volunteer/" + id;
		return $resource(url, null, {
			'update' : {
				method : 'PUT'
			},
	...
	function activateService() {
		var url = $rootScope.apiUrl + "loginusers/activate";
		return $resource(url);
	}
	
	function updatePasswordService() {
		var url = $rootScope.apiUrl + "loginusers/updatepassword";
		return $resource(url);
	}

	function findEmailService(email) {
		var url = $rootScope.apiUrl + "loginusers/email/" + email;
		return $resource(url);
	}
	
	function updatePasswordEmailService(email) {
		var url = $rootScope.apiUrl + "loginusers/updatepassword/" + email;
		return $resource(url);
	}

	function forgotPasswordService(email,role) {
		var url = $rootScope.apiUrl + "loginusers/forgotpassword/" + email+"/"+role;
		return $resource(url);
	}

	function loginusersByLoginIdService(loginId , password) {
		var url = $rootScope.apiUrl + "loginusers/"+loginId+"/"+password;
		return $resource(url);
	}
	...
	function backerService(id) {
		var url = $rootScope.apiUrl + "backer/" + id;
		return $resource(url, null, {
			'update' : {
				method : 'PUT'
			},
	...
	function patientsService() {
		var url = $rootScope.apiUrl + "patients";
		return $resource(url);
	}
	
	function blogsService() {
		var url = $rootScope.apiUrl + "blogs";
		return $resource(url);
	}
}