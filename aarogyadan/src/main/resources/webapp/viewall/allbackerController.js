...
angular.module('aarogyadanWebApp')
	.controller('allbackerController', allbackerController);

allbackerController.$inject = ['$http', '$rootScope', '$scope', '$state', 'restAPIService', 'dialogs'];

function allbackerController ($http, $rootScope, $scope, $state, restAPIService, dialogs) {
