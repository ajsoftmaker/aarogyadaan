...
angular.module('aarogyadanWebApp')
	.controller('allvolunteerController', allvolunteerController);

allvolunteerController.$inject = ['$http', '$rootScope', '$scope', '$state', 'restAPIService', 'dialogs'];

function allvolunteerController ($http, $rootScope, $scope, $state, restAPIService, dialogs) {
